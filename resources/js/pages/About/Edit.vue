...
const form = useForm({
    ...
    order: props.about.order,
    is_published: props.about.is_published,
});

const submit = () => {
    form.put(`/about/${props.about.id}`, {
        onSuccess: () => {
            console.log('About content updated successfully');
        },
        onError: (errors) => {
            console.error('Error updating about content:', errors);
        }
    });
};
</script>
            ...
            <main class="flex w-full max-w-[800px] flex-col overflow-hidden rounded-lg lg:max-w-4xl">
                <div class="flex flex-col items-center justify-center w-full">
                    <div class="w-full mb-8">
                        <h1 class="text-3xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Edit About Content</h1>
                        <p class="text-gray-600 dark:text-gray-400 mt-2">Update the content for the About page.</p>
                    </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex gap-4 pt-4">
                                <button
                                    ...
                                    class="flex-1 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-medium py-3 px-6 rounded-lg transition duration-200"
                                >
                                    <span v-if="form.processing">Updating...</span>
                                    <span v-else>Update About Content</span>
                                </button>
